...
public class TweetToEmbeddingsFeatureVectorTest extends AbstractFilterTest {

    public TweetToEmbeddingsFeatureVectorTest(String name) {
        super(name);
    }
    ...
    public static Test suite() {
        return new TestSuite(TweetToEmbeddingsFeatureVectorTest.class);
    }
